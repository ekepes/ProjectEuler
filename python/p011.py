...
grid.append([81, 49, 31, 73, 55, 79, 14, 29, 93, 71, 40, 67, 53, 88, 30, 13, 49, 13, 36, 65])
...
grid.append([24, 47, 32, 60, 99, 13, 45, 2, 44, 75, 33, 53, 78, 36, 84, 20, 35, 17, 12, 50])
...
grid.append([78, 17, 53, 28, 22, 75, 31, 67, 15, 94, 13, 80, 4, 62, 16, 14, 9, 53, 56, 92])
...
grid.append([88, 36, 68, 87, 57, 62, 20, 72, 13, 46, 33, 67, 46, 55, 12, 32, 63, 93, 53, 69])
